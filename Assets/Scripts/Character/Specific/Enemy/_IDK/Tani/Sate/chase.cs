...
public class Chase : TaniState
{
    private static readonly Color StateColor = Color.yellow;

    public Chase(TaniStateMachine stateMachine) : base(stateMachine)
    {
    }
    ...
    public override void DrawGizmos()
    {
        ...
        if (player != null && StateMachine.CanSeePlayer())
        {
            ...
            Gizmos.DrawLine(StateMachine.transform.position, player.position);
        }
    }
}
